#ifndef LL_INTERFACE_H_INCLUDED
#define LL_INTERFACE_H_INCLUDED
...
class LL_Button:public LL_Interface
{
    ...
    public:
        ...
        //TEXT CONFIGURATION
        void set_message(string message){_message=message;Xsize=_message.size()*_font_size;middle_x=(Xsize*scale_x/2);}
